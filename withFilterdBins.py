...
if __name__ == "__main__":
    ...
    parser.add_argument("-filteredBins", "--b", help="depth file dir. e.g. /Users/Result/filterBins.csv")
    
    args = parser.parse_args()
    
    print( "fa file is in: {} depth file is in {} filteredBins file is in {}".format(
            args.f,
            args.d,
            args.b
            ))
